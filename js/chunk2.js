/* ==========================================================================
   Vendor chunk: Utility modules (lodash-like helpers & runtime shims)
   - Contains helper modules (collections, arrays, typed arrays, maps, sets) used across the site.
   - This file is an auto-generated webpack chunk bundling many small utility modules.
   - Purpose: provide fast, shared low-level helpers to higher-level modules (Webflow runtime).
   NOTE: No logic changes; this is a non-intrusive top-level comment for readability.
   ========================================================================== */
