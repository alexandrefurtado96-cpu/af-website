...
(self.webpackChunk = self.webpackChunk || []).push([
  ["331"],
  {
    5487: function () {
      /* ==========================================================================
         Tram (animation/tweening engine)
         - Provides easing functions, tween classes, timelines, and helper utilities.
         - Key API: e.tween, e.delay, e.frame, e.now, and integration via the jQuery plugin.
         - Used by Webflow to handle animations and transitions in components.
         ========================================================================== */
    ...
    9461: function (t, e, n) {
      ...
      /* ==========================================================================
         Module: brand
         Purpose: Manage the Webflow branding badge (append/remove depending on env).
         Exposes: ready() to initialize the badge and handle fullscreen changes.
         ========================================================================== */
      i.define(
        "brand",
    ...
    322: function (t, e, n) {
      ...
      /* ==========================================================================
         Module: edit
         Purpose: Load and boot the Webflow editor (in-browser site editor) and handle third-party cookie checks.
         Exposes: ready() to set up the editor iframe and message handling.
         ========================================================================== */
      i.define(
        "edit",
    ...
    8334: function (t, e, n) {
      ...
      /* ==========================================================================
         Module: focus
         Purpose: Polyfill/fix focus behavior (focus-within) for certain browsers and handle focus events.
         Exposes: ready() to attach focus-related handlers when Webflow is initialized.
         ========================================================================== */
      i.define(
        "focus",
        (t.exports = function () {
    ...
    7199: function (t) {
      /* ==========================================================================
         Module: w-ix triggers
         Purpose: Queue and dispatch interaction (IX) intro/outro triggers with jQuery.
         - Keeps triggers async-safe and exposes reset/intro/outro helper APIs used by animations.
         ========================================================================== */
      var e = window.jQuery,
        n = {},
        i = [],
    ...
    5134: function (t, e, n) {
      /* ==========================================================================
         Module: IX event bridge
         Purpose: Convert internal IX triggers to DOM CustomEvents (COMPONENT_ACTIVE / COMPONENT_INACTIVE)
         - Allows components and third-party code to listen for lifecycle events via the DOM.
         ========================================================================== */
      var i = n(7199);
      function r(t, e) {
    ...
    3949: function (t, e, n) {
      /* ==========================================================================
         Core: Webflow runtime
         Purpose: Module registry, environment detection, lifecycle hooks (ready/load/destroy), and utilities.
         - Use Webflow.define() to register modules and Webflow.require() to access them.
         ========================================================================== */
      var i,
        r,
        o = {}, 
    ...
    7624: function (t, e, n) {
      ...
      /* ==========================================================================
         Module: links
         Purpose: Track active section links and update link states as the page scrolls.
         ========================================================================== */
      i.define(
        "links",
    ...
    286: function (t, e, n) {
      ...
      /* ==========================================================================
         Module: scroll
         Purpose: Smooth scrolling, hash navigation, and reduced-motion preferences handling.
         ========================================================================== */
      i.define(
        "scroll",
        (t.exports = function (t) {
    ...
    3695: function (t, e, n) {
      /* ==========================================================================
         Module: touch
         Purpose: Normalize touch events and provide tap/swipe utilities across devices.
         ========================================================================== */
      n(3949).define(
        "touch",
        (t.exports = function (t) {
    ...
    9858: function (t, e, n) {
      ...
      /* ==========================================================================
         Module: dropdown
         Purpose: Handle dropdown open/close behavior, hover vs click configs, keyboard navigation, and accessibility attributes.
         ========================================================================== */
      i.define(
        "dropdown",
        (t.exports = function (t, e) {
    ...
    1655: function (t, e, n) {
      ...
      /* ==========================================================================
         Module: navbar
         Purpose: Manage responsive navigation (menu button, overlay, dropdowns, and keyboard access).
         ========================================================================== */
      i.define(
        "navbar",
        (t.exports = function (t, e) {
